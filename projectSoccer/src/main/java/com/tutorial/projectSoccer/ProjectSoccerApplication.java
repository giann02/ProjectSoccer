...
import com.tutorial.projectSoccer.persistence.entity.PermissionEntity;
import com.tutorial.projectSoccer.persistence.entity.RoleEntity;
import com.tutorial.projectSoccer.persistence.entity.RoleEnum;
import com.tutorial.projectSoccer.persistence.entity.UserEntity;
import com.tutorial.projectSoccer.persistence.repository.UserRepository;
...
public class ProjectSoccerApplication {
	...
	public GroupedOpenApi groupedOpenApi() {
		return GroupedOpenApi.builder()
				.group("api")
				.packagesToScan("com.tutorial.projectSoccer.controller")// Especifica las rutas para las que quieres habilitar la autorización
				.build();
	}
